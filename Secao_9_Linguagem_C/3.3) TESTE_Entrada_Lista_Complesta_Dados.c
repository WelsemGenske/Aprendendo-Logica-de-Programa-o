...
int main()
{
    ...
    ler_texto(nome1, 50);                        // Funcao Ler_Texto
    printf("Salario da primeira pessoa: ");
    scanf("%lf", &salario1);

    printf("Nome da segunda pessoa: ");
    limpar_entrada();                            // Funcao Limpar entradas do teclado, antes do texto.
    ler_texto(nome2, 50);
    ...
    limpar_entrada();                            // Funcao Limpar-Entrada (mesmo sendo um texto de 1 Caracter).
    scanf("%c", &sexo);
